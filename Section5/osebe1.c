...
} oseba;	//nov nain, da ni treba vedno pisat struct
//typedef uporabimo nad strukturo, da nridmo svoj tip
//typedef definira poljuben tip

int primerjaj( oseba o1,  oseba o2){
...
int main(void){
	...
	*/
	 ...
	 oseba osebe[N];  //oseba je ime pdoatkovnega tipa. To je tablea N oseb
	for(int i = 0; i < N; i++) {
